...
class MaterialModelForm(forms.ModelForm):
    ...
    class Meta:
        model = Materiais
        fields = ['id_material','nm_material', 'unidade', 'preco_compra', 'tipo', 'validade_ca', 'localizacao']
        labels = {
            'nm_material': "",
            'unidade': "",
            'preco_compra': "",
        ...
        def __init__(self, *args, **kwargs):
            ...
            self.fields['nm_material'].queryset = MaterialModelForm.objects.filter(id_material=MaterialModelForm)
