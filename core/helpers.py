...
error_messages = {
    ...
    'digits_only': _("Este campo aceita somente números"),
    'max_digits': _("Este campo requer examente 11 dígitos."),
}
...
def validate_file_extension(value):
  ...
  valid_extensions = ['.pdf','.png','.jpg','.csv']
  if not ext in valid_extensions:
    raise ValidationError(u'Tipos de Arquivos suportados: pdf, png, jpg, csv')